...
export const enemies = [
  ...
  // 🧙‍♂️ Magos e elementais (com comportamento ranged)
  ...
  { id: 'EsqueletoMago2', x: 42, y: 35, level: 7, xp: 90, health: 70, maxHealth: 70, atk: 14, def: 4, spd: 5, patrolArea: { x1: 40, y1: 33, x2: 44, y2: 37 }, cooldown: 0 },
  ...
  { id: 'ElementalGelo', x: 45, y: 15, level: 9, xp: 130, health: 180, maxHealth: 180, atk: 19, def: 5, spd: 4, patrolArea: { x1: 43, y1: 13, x2: 47, y2: 17 }, cooldown: 0 },
...
// 🧱 Paredes (liberando saída da safe zone)
export const walls = [
  { x: 2, y: 3 }, { x: 2, y: 4 },
  { x: 5, y: 3 }, { x: 5, y: 4 },
  { x: 3, y: 5 }, { x: 4, y: 5 },
